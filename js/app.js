/* Simulation of live api. API is not working due to over load */
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <p class="text-muted"><i class="fas fa-star"></i> ${product.rating.rate} (${product.rating.count})</p>
      <h3>${product.title}</h3>
...
const updateTaxAndCharge = () => {
  const updatedPrice = getInputValue("price");
  if (updatedPrice > 200) {
    setInnerText("delivery-charge", 30);
    setInnerText("total-tax", updatedPrice * 0.2);
  }
  if (updatedPrice > 400) {
    setInnerText("delivery-charge", 50);
    setInnerText("total-tax", updatedPrice * 0.3);
  }
  if (updatedPrice > 500) {
    setInnerText("delivery-charge", 60);
    setInnerText("total-tax", updatedPrice * 0.4);
  }
};
